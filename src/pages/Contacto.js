        ...
        <>
            <section className="pt-48 px-4 2xl:px-0">
                <div className="container mx-auto flex flex-col justify-start items-start">
                    <Link to={'mailto:andres.graficoweb@gmail.com'} className="link-hero text-white text-2xl font-neutral font-ClashDisplay flex gap-2 md:gap-4 items-center z-10"><FontAwesomeIcon icon={faEnvelope} style={{ fontSize: 15 }} className="text-primary" /> conectemos@andresuidesign.com</Link>
